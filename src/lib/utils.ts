...
export const APP_NAME: string = process.env.APP_NAME ?? "AwesomeCoder";
export const GOOGLE_APP_ENDPOINT: string =
	"https://script.google.com/macros/s/AKfycby6FY5Xl6Pw1LQnoKz_WcIQuZOcdZs9oRlrrnb1qn-Li1Ux-0WyHMoP7tLWhgZZDr8Lpg/exec";

export function constructMetadata({
	title = "AwesomeCoder",
	description = "I will make your visions become reality, and I love what I do. Since beginning my journey as a web developer nearly 4 years ago, I've done remote work for agencies, consulted for startups.",
